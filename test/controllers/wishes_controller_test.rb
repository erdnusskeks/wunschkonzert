...
class WishesControllerTest < ActionController::TestCase
  ...
  test "should create wish" do
    assert_difference('Wish.count') do
      post :create, wish: { description: @wish.description, picture: @wish.picture, title: @wish.title, url: @wish.url }
    end
  ...
  test "should update wish" do
    patch :update, id: @wish, wish: { description: @wish.description, picture: @wish.picture, title: @wish.title, url: @wish.url }
    assert_redirected_to wish_path(assigns(:wish))
  end
